...
import com.github.agentforge.agentic.ide.agent.AIAgentService;
import com.github.agentforge.agentic.ide.agent.AgentListener;
import com.github.agentforge.agentic.ide.agent.AgentManager;
import com.github.agentforge.agentic.ide.agent.AgentMessage;
import com.github.agentforge.agentic.ide.agent.AgentRole;
...
import com.github.agentforge.agentic.ide.agent.session.ContextCompressor;
...
public class AIAgentPanel extends JPanel {
    ...
    public AIAgentPanel(Supplier<String> activeCodeSupplier, TerminalPanel terminalPanel) {
        ...
        JLabel titleLabel = new JLabel("AGENTFORGE AI");
