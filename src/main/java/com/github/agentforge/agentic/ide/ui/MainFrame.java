package com.github.agentforge.agentic.ide.ui;
...
import com.github.agentforge.agentic.ide.ui.components.SettingsDialog;
import com.github.agentforge.agentic.ide.ui.components.StatusBar;
import com.github.agentforge.agentic.ide.ui.components.TerminalPanel;
import com.github.agentforge.agentic.ide.ui.components.ToolBar;
import com.github.agentforge.agentic.ide.ui.menu.AppMenuBar;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        super("AgentForge AI Agent IDE - Autonomous Coding Environment");
        ...
        if (sampleFile.exists()) {
            ...
            if (javaFiles != null && javaFiles.length > 0) {
                ...
                editorPanel.newFile("Welcome.java", """
                        // Welcome to AgentForge AI Agent IDE!
                        public class Welcome {
                            public static void main(String[] args) {
                                System.out.println("AgentForge AI Agent IDE with Agentic Memory is ready.");
                            }
                        }
                        """);
            }
