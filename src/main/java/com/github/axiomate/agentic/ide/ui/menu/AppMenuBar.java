package com.github.axiomate.agentic.ide.ui.menu;
...
/**
 * Main application menu bar for Axiomate AI IDE with Agentic Memory integration.
 */
public class AppMenuBar extends JMenuBar {
    ...
    public AppMenuBar(JFrame mainFrame,
        ...
        reconnectMcpItem.addActionListener(e -> {
            com.github.axiomate.agentic.ide.mcp.McpManager.getInstance().connectAllEnabled();
        ...
        newSessionItem.addActionListener(e -> {
            ...
            if (name != null && !name.isBlank()) {
                com.github.axiomate.agentic.ide.agent.session.SessionManager.getInstance()
        ...
        compressContextItem.addActionListener(e -> {
            var session = com.github.axiomate.agentic.ide.agent.session.SessionManager.getInstance().getActiveSession();
            if (session != null) {
                var res = com.github.axiomate.agentic.ide.agent.session.ContextCompressor.compressIfExceeded(session, 0.0);
        ...
        JMenuItem aboutItem = new JMenuItem("About Axiomate IDE");
    ...
    private void showAboutDialog(JFrame parent) {
        String msg = """
                ...
                """;
        JOptionPane.showMessageDialog(parent, msg, "About Axiomate AI IDE", JOptionPane.INFORMATION_MESSAGE);
    }
}
